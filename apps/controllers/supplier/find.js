...
exports.findDetailSupplier = exports.findAllSupplier = void 0;
...
const findAllSupplier = async (req, res) => {
    try {
        ...
        const result = await supplier_1.SupplierModel.findAndCountAll({
            where: {
...
const findDetailSupplier = async (req, res) => {
    ...
    try {
        const supplier = await supplier_1.SupplierModel.findOne({
            where: {
                deleted: { [sequelize_1.Op.eq]: 0 },
                supplierKode: { [sequelize_1.Op.eq]: requestParams.supplierKode }
            }
        });
        if (supplier === null) {
...
exports.findDetailSupplier = findDetailSupplier;
